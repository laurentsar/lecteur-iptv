...
#define FFMPEG_CONFIGURATION "--libdir=android-libs/x86_64 --arch=x86_64 --cpu=x86-64 --cross-prefix=/opt/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android22- --nm=/opt/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm --ar=/opt/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar --ranlib=/opt/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib --strip=/opt/android-ndk-r26b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip --disable-asm --target-os=android --enable-static --disable-shared --disable-doc --disable-programs --disable-everything --disable-avdevice --disable-avformat --disable-swscale --disable-postproc --disable-avfilter --disable-symver --enable-swresample --extra-ldexeflags=-pie --disable-v4l2-m2m --disable-vulkan --enable-decoder=ac3 --enable-decoder=eac3 --enable-decoder=dca --enable-decoder=mlp --enable-decoder=truehd"
